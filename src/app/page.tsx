              ...
              <div className="group relative flex items-center justify-between rounded-lg border dark:border-white/10 border-black/10 dark:bg-white/5 bg-black/5 py-3 px-4 overflow-hidden transition-all duration-500 dark:hover:bg-white/10 hover:bg-black/10 hover:dark:border-white/20 hover:border-black/20 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-purple-500/10">
                ...
                <div className="relative z-10 pr-4 flex-1">
                  <div className="text-sm font-mono dark:text-neutral-300 text-neutral-700 leading-relaxed">
                    <a
                      ...
                      className="text-base font-bold font-pixel dark:text-white text-black mr-2 hover:underline cursor-pointer"
                    >
                      CheatCode CLI
                    </a>
                ...
                <div className="relative z-10 flex items-center gap-2">
                  <a
                    ...
                    className="p-1 rounded-md dark:text-neutral-400 text-neutral-600 dark:hover:text-white hover:text-black transition-colors cursor-pointer"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Live Site / Docs"
                    className="p-1 rounded-md dark:text-neutral-400 text-neutral-600 dark:hover:text-white hover:text-black transition-all duration-300 group-hover:rotate-45 group-hover:scale-110 cursor-pointer"
                  >
